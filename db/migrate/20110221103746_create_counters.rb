class CreateCounters < ActiveRecord::Migration
  def self.up
    create_table :counters do |t|
      ...
      t.integer :cnt_total_open,  :null => false, :default => 0
      t.integer :cnt_total,       :null => false, :default => 0

    end

    execute "INSERT INTO counters (user_id, collaboration_id, topic_id, " +
        "cnt_new, cnt_assigned, cnt_accepted, cnt_resolved, cnt_rejected, cnt_closed, cnt_total_open, cnt_total) " +
      ...
      "SUM ( CASE WHEN status<>'Closed'   THEN 1 ELSE 0 END ) as cnt_total_open, " +
      "COUNT(*) as cnt_total " +
      "FROM tasks "+
